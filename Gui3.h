...
//general functor sceleton:
//	has () operator that:
//		accepts current object pointer
//		accepts some specific stuff (naming: _v for nothing, _v2i for vec2i, _d_s for double and a string, etc).
//		returns nothing.
//  has void tell(message msg)
//  has msg ask(message msg)
class GUI3base2;
