...
void DLLAPI_UTIL initUtil();
void DLLAPI_UTIL selfdestruct();
...
string DLLAPI_UTIL toString(logmessage);

class DLLAPI_UTIL exKind : public exception {
    public:
    logmessage msg;
